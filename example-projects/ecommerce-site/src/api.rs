...
// Cache up to 100 requests, invalidating them after 60 seconds
#[cached::proc_macro::cached(size = 100, time = 60, result = true)]
pub(crate) async fn fetch_user(user_id: usize) -> Result<Product, reqwest::Error> {
...
// Cache up to 100 requests, invalidating them after 60 seconds
#[cached::proc_macro::cached(size = 100, time = 60, result = true)]
pub(crate) async fn fetch_product(product_id: usize) -> Result<Product, reqwest::Error> {
...
impl ProductInCart {
    pub async fn fetch_product(&self) -> Result<Product, reqwest::Error> {
