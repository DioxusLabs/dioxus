...
1. A tiny "evergreen" _bootstrapper_ which will fetch an installer from Microsoft's CDN
2. A tiny _installer_ which will fetch Webview2 from Microsoft's CDN
