...
Dioxus is a _declarative_ framework. This means that instead of manually writing calls to "create element" and "set element background to red," we simply _declare_ what we want the element to look like and let Dioxus handle the differences.
...
Instead, with Dioxus, we _declare_ what we want our UI to look like:
