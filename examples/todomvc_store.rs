...
fn app() -> Element {
    ...
    // We can use the methods generated by the store macro to zoom into the fields of the struct.
    // This gives us a Store<HashMap<u32, TodoItem>> for the todos and
    // a Store<FilterState> for the filter.
