...
use dioxus::prelude::*;
use dioxus_core::{UpdatePriority, with_update_priority};
...
export function installTriangleProbe() {
    ...
    window.addEventListener("dioxus-fiber-stats", (event) => {
        const detail = event.detail || {};
        fiberWork += detail.workCount || 0;
        fiberCommits += detail.commitCount || 0;
        fiberYields += detail.yieldCount || 0;
        setText("fiber-work", String(fiberWork));
        setText("fiber-commits", String(fiberCommits));
        setText("fiber-yields", String(fiberYields));
    });
...
fn app() -> Element {
    ...
    use_future(move || async move {
        ...
        loop {
            ...
            with_update_priority(UpdatePriority::ContinuousInput, || {
            ...
            if next_second != last_second {
                ...
                with_update_priority(UpdatePriority::Transition, || {
        ...
        main {
            ...
            section {
                ...
                div {
                    class: "title-block",
                    h1 { "Fiber Triangle" }
                    p { "Sierpinski dots tick every second while the triangle scales every frame." }
                }
                ...
                div {
                    ...
                    Metric { label: "Animation lane", value: "ContinuousInput".to_string() }
                    Metric { label: "Text lane", value: "Transition".to_string() }
                }

                div {
                    class: "stats",
                    Metric { label: "Fiber work", value: "0".to_string(), value_id: "fiber-work" }
                    Metric { label: "Fiber commits", value: "0".to_string(), value_id: "fiber-commits" }
                    Metric { label: "Fiber yields", value: "0".to_string(), value_id: "fiber-yields" }
