        ...
        section { class: "py-20",
            div { class: "container mx-auto px-4",
                div { class: "flex flex-wrap -mx-4 mb-24",
                    div { class: "w-full md:w-1/2 px-4 mb-8 md:mb-0",
                        div { class: "relative mb-10", style: "height: 564px;",
                            a {
                                class: "absolute top-1/2 left-0 ml-8 transform translate-1/2",
                                href: "#",
                                icons::icon_0 {}
                            }
                            img {
                            ...
                            a {
                                class: "absolute top-1/2 right-0 mr-8 transform translate-1/2",
                                href: "#",
                                icons::icon_1 {}
                            }
                        }
                            ...
                            div { class: "flex mb-12",
                                div { class: "mr-6",
                                    ...
                                    div { class: "inline-flex items-center px-4 font-semibold font-heading text-gray-500 border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md",
                                        ...
                                        input {
                                            class: "w-12 m-0 px-2 py-4 text-center md:text-right border-0 focus:ring-transparent focus:outline-hidden rounded-md",
                                            placeholder: "1",
                                            r#type: "number",
                                            value: "{quantity}",
                                            oninput: move |evt| {
                ...
                div {
                    ...
                    p { class: "max-w-2xl text-gray-500", "{description}" }
                }
            }
        }
    }
