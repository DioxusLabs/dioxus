...
#[component]
fn TodoHeader(mut todos: Write<HashMap<u32, TodoItem>>) -> Element {
...
#[component]
fn TodoEntry(mut todos: Write<HashMap<u32, TodoItem>>, id: u32) -> Element {
...
#[component]
fn ListFooter(
    mut todos: Write<HashMap<u32, TodoItem>>,
    active_todo_count: Read<usize>,
    mut filter: Write<FilterState>,
) -> Element {
