...
<div align="center">
  <h3>
    ...
    <span> | </span>
    <a href="https://github.com/DioxusLabs/examples"> Exemplos </a>
    <span> | </span>
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [![Explorador de Arquivos](https://github.com/DioxusLabs/examples/blob/master/file-explorer/assets/image.png)](https://github.com/DioxusLabs/examples/blob/master/file-explorer) | [![Wifi Scanner Demo](/examples/bluetooth-scanner/demo_small.png)](/examples/bluetooth-scanner/) | [![TodoMVC example](https://github.com/DioxusLabs/examples/raw/master/todomvc/example.png)](https://github.com/DioxusLabs/examples/blob/master/todomvc) | [![Exemplo de E-commerce](https://github.com/DioxusLabs/examples/raw/master/ecommerce-site/demo.png)](https://github.com/DioxusLabs/examples/blob/master/ecommerce-site) |
