...
pub trait Protocol<Input, Output, Error, InputStreamError = Error, OutputStreamError = Error> {
...
pub type LazyServerFnMap<Req, Res> =
...
pub mod axum {
    use crate::{
        error::FromServerFnError, middleware::BoxedService, LazyServerFnMap, Protocol, ServerFn,
        ServerFnTraitObj,
    };
    use axum::body::Body;
