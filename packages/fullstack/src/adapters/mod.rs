...
//!
//! Each framework has utilities for some or all of the following:
//! - Server functions
...
//! - A hot reloading web socket that integrates with [`dioxus-hot-reload`](https://crates.io/crates/dioxus-hot-reload)
