...
use crate::use_memo;
use dioxus_signals::{Read, Signal};

pub fn use_sorted<V: 'static, T: PartialEq>(collection: impl FnMut() -> Signal<V>) -> Read<Vec<T>>
// pub fn use_sorted<S, I, T>(iterable: impl FnMut() -> Signal<V>) -> Read<T>
// where
