...
use crate::{
    ...
    Mutations, OwnedAttributeValue, OwnedDynamicNodeMapping, StaticDynamicNodeMapping,
};
...
impl<'a> VTemplateRef<'a> {
    ...
    pub(crate) fn hydrate<'b: 'a, E: Edits<'a>>(
        ...
        fn hydrate_inner<'b, E, Nodes, Attributes, V, Children, Listeners, TextSegments, Text>(
            nodes: &Nodes,
            ctx: (
                &mut DiffState<'b, E>,
                &'b VTemplateRef<'b>,
...
impl Template {
    ...
    fn create_node<'b, E: Edits<'b>>(
        ...
        fn crate_node_inner<'b, E, Attributes, V, Children, Listeners, TextSegments, Text>(
