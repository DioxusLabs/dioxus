...
impl<'b, E: Edits<'b>> DiffState<'b, E> {
    ...
    fn diff_template_ref_nodes(
        ...
        fn diff_attributes<'b, E, Nodes, Attributes, V, Children, Listeners, TextSegments, Text>(
            nodes: &Nodes,
            ctx: (
                &mut DiffState<'b, E>,
                &'b Bump,
        ...
        fn set_attribute<'b, E, Attributes, V, Children, Listeners, TextSegments, Text>(
            node: &TemplateNode<Attributes, V, Children, Listeners, TextSegments, Text>,
            ctx: (&mut DiffState<'b, E>, &'b Bump, &'b VTemplateRef<'b>, usize),
        ) where
            E: Edits<'b>,
            Attributes: AsRef<[TemplateAttribute<V>]>,
            V: TemplateValue,
        ...
        fn diff_text<'b, E, Attributes, V, Children, Listeners, TextSegments, Text>(
            node: &TemplateNode<Attributes, V, Children, Listeners, TextSegments, Text>,
            ctx: (
                &mut DiffState<'b, E>,
                &'b VTemplateRef<'b>,
