use anyhow::Context;
use manganis_core::{Asset, AssetOptions, CssAssetOptions, ImageAssetOptions, JsAssetOptions};
use std::path::{Path, PathBuf};

use super::{css::process_css, image::process_image, js::process_js, json::process_json};
