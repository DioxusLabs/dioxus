...
"#,
    ...
    fn inject_resources(
            ...
            match asset.options().variant() {
                AssetVariant::Css(css_options) => {
                    if css_options.preloaded() {
                        _ = write!(head_resources, "<link rel=\"preload\" as=\"style\" href=\"/{{base_path}}/assets/{asset_path}\" crossorigin>");
                    }
                    if !css_options.dynamic() {
                        _ = write!(head_resources, "<link rel=\"stylesheet\" href=\"/{{base_path}}/assets/{asset_path} type=\"text/css\"\">");
                    }
                }
                AssetVariant::Image(image_options) => {
                    if image_options.preloaded() {
                        _ = write!(head_resources, "<link rel=\"preload\" as=\"image\" href=\"/{{base_path}}/assets/{asset_path}\" crossorigin>");
                    }
                }
                AssetVariant::Js(js_options) => {
                    if js_options.preloaded() {
                        _ = write!(head_resources, "<link rel=\"preload\" as=\"script\" href=\"/{{base_path}}/assets/{asset_path}\" crossorigin>");
                    }
                    if !js_options.dynamic() {
                        _ = write!(
                            head_resources,
                            "<script src=\"/{{base_path}}/assets/{asset_path}\"></script>"
                        );
                    }
                }
                _ => {}
        ...
        _ = write!(head_resources, "<link rel=\"preload\" as=\"fetch\" type=\"application/wasm\" href=\"/{{base_path}}/{wasm_path}\" crossorigin>");
